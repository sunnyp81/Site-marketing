...
Once the fixes are live, don't guess whether they worked — measure. The 20-prompt method inside **[the 90-minute audit](/strategy/audit/)** is the fastest way to get an honest citation-share number: write 20 buyer-language prompts, run them through ChatGPT, Perplexity and Gemini in fresh sessions, and log who gets cited. Across our own 50-site pilot, the median site's citation share before any of this was **8%** — most owners guessed either zero or "everywhere," and both were wrong, which is the whole argument for measuring instead of guessing. Full pilot methodology: **The Citation-Share Study**<!-- relink: /research/citation-share-study/ -->. Once you're doing this quarterly rather than once, stop doing it by hand: **[AI Citation Monitoring: Tools and a DIY Method](/measurement/citation-monitoring/)**.
